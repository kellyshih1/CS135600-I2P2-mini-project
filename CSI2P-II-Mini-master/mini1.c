...
int main() {
	...
	while (fgets(input, MAX_LENGTH, stdin) != NULL) {  
		...
		// if (ast_root) codegen_file(ast_root); 
		// AST_print(ast_root); 
...
// 			AST *tmp = root->lhs; 
// 			while (tmp->kind == LPAR) tmp = tmp->mid; 
// 			int r2 = codegen_file(root->rhs);
// 			if (tmp->val == 'x') {
// 				fprintf(fout, "store [0] r%d\n", r2); 
// 			} else if (tmp->val == 'y') {
// 				fprintf(fout, "store [4] r%d\n", r2); 
// 			} else {
// 				fprintf(fout, "store [8] r%d\n", r2); 
// 			}
// 			return r2; 
// 		}
// 		case ADD:
// 		{
// 			int r1 = codegen_file(root->lhs); 
// 			int r2 = codegen_file(root->rhs); 
...
// 			if (tmp->val == 'x') {
// 				fprintf(fout, "load r%d [0]\n", cur_reg); 
// 				fprintf(fout, "add r%d r%d 1\n", cur_reg, cur_reg); 
// 				fprintf(fout, "store [0] r%d\n", cur_reg); 
// 			} else if (tmp->val == 'y') {
// 				fprintf(fout, "load r%d [4]\n", cur_reg); 
// 				fprintf(fout, "add r%d r%d 1\n", cur_reg, cur_reg); 
// 				fprintf(fout, "store [4] r%d\n", cur_reg); 
// 			} else {
// 				fprintf(fout, "load r%d [8]\n", cur_reg); 
// 				fprintf(fout, "add r%d r%d 1\n", cur_reg, cur_reg); 
// 				fprintf(fout, "store [8] r%d\n", cur_reg); 
// 			}
// 			return cur_reg; 
